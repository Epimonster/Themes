...
(function() {var css = [
        ...
        "   background: #4285F4 !important; /* Old browsers */",
        "   background: -moz-linear-gradient(left, #1b1b1b 0%, #4285F4 100%) !important;",
        "   background: -webkit-gradient(linear, left top, right top, color-stop(0%,#1b1b1b), color-stop(100%,#4285F4)) !important;",
        "   background: -webkit-linear-gradient(left, #1b1b1b 0%,#4285F4 100%) !important;",
        "   background: -o-linear-gradient(left, #1b1b1b 0%,#4285F4 100%) !important;",
        "   background: -ms-linear-gradient(left, #1b1b1b 0%,#4285F4 100%) !important;",
        "   background: linear-gradient(to right, #1b1b1b 0%,#4285F4 100%) !important;",
        "}",
        ...
        "   box-shadow: 0px 0px 3px #4285F4, 0px 0px 5px #4285F4, 0px 0px 0px #4285F4 !important;",
        ...
        "   border-color: #1B1B1B !important;",
        "   box-shadow: 0px 0px 6px #4285F4, 0px 0px 8px #4285F4, 0px 0px 10px #4285F4 !important;",
        "}",
        "/* volume control */",
